...
import com.solwyz.haseena.config.CurrentUser;
import com.solwyz.haseena.config.JwtTokenUtil;
import com.solwyz.haseena.entity.RefreshToken;
import com.solwyz.haseena.entity.User;
import com.solwyz.haseena.exception.GenericException;
import com.solwyz.haseena.pojo.request.AuthenticationRequest;
import com.solwyz.haseena.pojo.request.ResetPasswordRequest;
import com.solwyz.haseena.pojo.response.AuthenticationResponse;
import com.solwyz.haseena.pojo.response.MessageResponse;
import com.solwyz.haseena.repo.UserRepository;
import com.solwyz.haseena.service.RefreshTokenService;
...
public class AuthController {
	...
	public ResponseEntity<?> createAuthenticationToken(@RequestBody AuthenticationRequest authenticationRequest) throws Exception {
	    ...
	    String allowedPassword = "HazeenaChemicals@2025";
...
//        userService.sendResetTokenEmail(token, user.get());
//
//        return new MessageResponse("Reset Password Link Sent to Registered Email or Mobile");
//    }
//
//	   
...
//	                .loadUserByUsernameAndPass(authenticationRequest.getUsername(), authenticationRequest.getPassword());
//
